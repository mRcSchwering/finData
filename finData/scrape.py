...
# TODO use Schema class instead of defining class vars
# TODO divide Scraper and Request class
# TODO Scraper with BoerseScraper child
# TODO Request with AlphaRequest child
